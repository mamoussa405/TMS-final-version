...
<body>
            ...
            <tr>
                <td align="center">
                    <font size="2"><img align="middle"
                            ...
                            alt="JESA" title="JESA" width="145" vspace="0" hspace="10" height="auto" /><br /><br />
                    </font>
                </td>
            </tr>
            <tr>
                <td align="center">
                    ...
                    <p align="center">
                        <font size="2"><b>Pursuant to the Professional Services Agreement, effective 27th April, 2019
                                between (i) Jacobs Engineering Inc. (Jacobs) and (ii) JESA SA (JESA), (the
                ...
                <td>
                    ...
                    <p>
                        <font size="2">2.&nbsp; This Task Order incorporates the terms, conditions and provisions of the
                            JPSA. Jacobs Affiliate and JESA Affiliate will be bound by the terms, conditions and
                            provisions of the JPSA as if it had been the original party to the JFSA in the same capacity
                            as Jacobs or JESA, respectively, and, accordingly for the purposes of this Task Order,
                            references in the JPSA to &ldquo;Jacobs&rdquo; shall be construed as references to
                            &ldquo;Jacobs Affiliate&rdquo;. Likewise, for the purposes of this Task Order, references in
                            the JPSA to &ldquo;JESA&rdquo; shall be construed as references to &ldquo;JESA
                            Affiliate&rdquo;.</font>
                    </p>
                    <p>
                        <font size="2">3.&nbsp; Where a JESA Affiliate or a Jacobs Affiliate has executed the present
                            Task Order, JESA Affiliate and Jacobs Affiliate will release JESA and Jacobs, and JESA and
                            Jacobs will release each other from any and all obligations and liabilities arising out of
                        ...
                        <tbody>
                            <tr>
                                <td style="width: 50%;">
                                    ...
                                    <p>
                                        <font size="2">JE or JE Affiliate</font><br /><br /><br /><br />
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td
                                                    style="border: 1px solid #000000; width: 57%; background: #FFFFFF; font-weight: normal;">
                                                    <span style="background-color: yellow; color: black;">DO NOT
                                                        SET&nbsp;<span>@#toRef</span> PROJECT UP AS A JESA PROJECT! THIS
                                                        IS FOR INVOICING ONLY</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
    ...
    <p></p>
    <div id="gtx-trans" style="position: absolute; left: 571px; top: 1441px;">
